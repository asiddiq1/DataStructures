...
//  (if over an hour, just write "> 1 hour")

//All Array Implementations
//  read_corpus time                   = 149.578
//  print_corpus (sort not print) time = 1456.96

//Almost All Array Implementations (except HeapPriorityQueue and BSTMap)
//  read_corpus time                   = 0.7476
//  print_corpus (sort not print) time = 0.229286
